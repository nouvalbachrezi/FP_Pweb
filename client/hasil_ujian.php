    ...
    <body class="d-flex flex-column min-vh-100">
        <div class="col-12 m-0 p-0" id="header">
            <div class="col-12 m-0 px-5 py-2 bg-black d-flex justify-content-between">
                ...
                <div class="d-flex align-items-center px-3">
                    <a class="text-decoration-none" href="./hasil_ujian.php"><p class="m-0 p-0 primary-font text-primary">Cek Hasil Ujian</p></a>
                </div>
                <div class="d-flex align-items-center px-3">
                ...
                <div class="card-corner bg-light p-4"> 
                    <div class="row col-12">
                        <div class="row d-flex flex-column">
                            <div class="pb-3">
                                <p class="primary-font fs-4 text-center">Cek Hasil Ujian</p>
                            </div>
                            <div class="pb-3">
                                <p class="primary-font fs-5">Hasil ujian belum keluar</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script type="text/javascript" src="./hasil_ujian.js"></script>
    </body>
</html>
<?php endif ?>